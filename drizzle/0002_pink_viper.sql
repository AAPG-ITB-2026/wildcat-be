...
CREATE TABLE "team_administration" (
	...
	"lead_ktm" text NOT NULL,
	"m1_ktm" text,
	"m2_ktm" text,
	"twibbon_proof" text NOT NULL,
	"poster_proof" text NOT NULL,
...
ALTER TABLE "app_content" DROP CONSTRAINT "app_content_section_unique";
...
ALTER TABLE "app_config" ALTER COLUMN "key" SET DATA TYPE varchar(100);
ALTER TABLE "app_config" ALTER COLUMN "updated_at" SET NOT NULL;
ALTER TABLE "app_content" ADD PRIMARY KEY ("section");
ALTER TABLE "app_content" ALTER COLUMN "section" SET DATA TYPE varchar(100);
ALTER TABLE "app_content" ALTER COLUMN "updated_at" SET NOT NULL;
...
ALTER TABLE "submissions" ADD COLUMN "file_url" text NOT NULL;
...
ALTER TABLE "app_content" DROP COLUMN "id";
ALTER TABLE "submissions" DROP COLUMN "submission_url";
